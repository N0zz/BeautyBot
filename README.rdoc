...
Simple twitch.tv chat bot written in ruby - version 0.3.1.
...
Live demo and useful hosted version can be found at:
- http://twitch.tv/beautiful_existence
- http://twitch.tv/bjutibot
- http://skyots.pl
